...
export async function placeOrder(body: ANT_API.Order, options?: { [key: string]: any }) {
  return request<ANT_API.Order>('/store/order', {
    method: 'POST',
    data: body,
    ...(options || {}),
  });
...
export async function getOrderById(
  ...
  return request<ANT_API.Order>(`/store/order/${param0}`, {
    method: 'GET',
    params: { ...params },
    ...(options || {}),
  });
