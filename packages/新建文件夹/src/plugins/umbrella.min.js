...
(u.prototype = {
  ...
  (u.prototype.filter = function(e) {
    var t = function(t) {
      return (
        (t.matches =
          t.matches || t.msMatchesSelector || t.webkitMatchesSelector),
        t.matches(e || "*")
      );
    };
    return (
  ...
  (u.prototype.off = function(t, e, n) {
    var r = null == e && null == n,
      ...
      i = e;
    return (
      "string" == typeof e && ((o = e), (i = n)),
      this.eacharg(t, function(e, n) {
        u(e._e ? e._e[n] : []).each(function(t) {
          (r || (t.orig_callback === i && t.selector === o)) &&
            e.removeEventListener(n, t.callback);
        });
      })
    );
  }),
  (u.prototype.on = function(t, e, o) {
    ...
    return this.eacharg(t, function(t, e) {
      t.addEventListener(e, r),
        (t._e = t._e || {}),
        (t._e[e] = t._e[e] || []),
        t._e[e].push({ callback: r, orig_callback: n, selector: i });
    });
  }),
  ...
  //   module.exports &&
  //   ((module.exports = u), (module.exports.u = u));
export default u
